...
"Sharing your hardware information allows us to design software that is more tailored for the average computer." = "Partager vos informations mat�rielles nous permet de concevoir des logiciels mieux adapt�s � l'ordinateur moyen."
)";
...
"Sharing your hardware information allows us to design software that is more tailored for the average computer." = "Compartir la informaci�n de su hardware nos permite dise�ar software que se adapta mejor al ordenador promedio."
)";
        std::unique_ptr<juce::LocalisedStrings> strings(new juce::LocalisedStrings(fileContents, true));
        juce::LocalisedStrings::setCurrentMappings(strings.release());
    }

    shareHardwareInfoButton.setTooltip(juce::translate("Sharing your hardware information allows us to design software that is more tailored for the average computer."));
